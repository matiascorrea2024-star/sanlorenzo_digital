    ...
    <div className="rounded-2xl border border-indigo-400/30 bg-indigo-500/10 p-5">
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 rounded-xl border border-white/15 bg-black/30 px-4 py-2.5 text-sm outline-none focus:border-indigo-400"
        />
        <button onClick={save} disabled={saving}
          className="rounded-xl bg-indigo-500 px-5 py-2.5 text-sm font-black text-white hover:opacity-90 disabled:opacity-50">
