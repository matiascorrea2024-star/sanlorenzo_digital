...
export default function PlatformWhatsappSetting() {
  ...
  return (
    <div className="rounded-[1.5rem] border border-[var(--accent)]/25 bg-[var(--accent)]/[.06] p-1.5">
      <div className="rounded-[1.1rem] border border-[var(--ov-05)] bg-[var(--card-inner)] p-5 shadow-[inset_0_1px_1px_var(--card-inner-highlight)]">
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 rounded-xl border border-[var(--line-strong)] bg-[var(--card-inner)] px-4 py-2.5 text-sm text-[var(--text)] outline-none focus:border-[var(--accent)]"
          />
          <button onClick={save} disabled={saving}
            className="rounded-full bg-[var(--accent)] px-5 py-2.5 text-sm font-black text-white hover:opacity-90 disabled:opacity-50">
