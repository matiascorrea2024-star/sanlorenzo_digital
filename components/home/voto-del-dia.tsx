              ...
              <div key={o.id} className={`rounded-2xl border p-3 transition ${i === 0 && v > 0 ? "border-yellow-400/50 bg-yellow-500/10" : "border-[var(--line)] bg-[var(--ov-02)]"}`}>
                <div className="flex items-center gap-3">
                  ...
                  <button onClick={() => votar(o.id)}
                    className={`flex shrink-0 items-center gap-1.5 rounded-xl px-3 py-2 text-xs font-black transition ${yo ? "bg-[var(--accent)] text-white" : "border border-[var(--line-strong)] text-[var(--muted)] hover:border-[var(--accent)]/50"}`}>
