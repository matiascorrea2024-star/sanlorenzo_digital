...
export default function Colecciones({ counts }: { counts: Map<string, number> }) {
  ...
  return (
    <section className="border-b border-white/5 px-4 py-14 sm:px-6 md:py-20" aria-labelledby="colecciones-title">
      <div className="mx-auto max-w-[1700px]">
        ...
        <h2 id="colecciones-title" className="mt-3 font-display text-4xl uppercase leading-[0.9] tracking-tight text-[#f7f3ec] sm:text-5xl md:text-6xl">
          ...
          {activas.map((c) => {
            ...
            return (
              <Link
                ...
                className="card-lift group w-[15rem] shrink-0 rounded-3xl border border-white/5 bg-[#161314] p-5 transition-all duration-700 ease-[cubic-bezier(0.165,0.84,0.44,1)] hover:-translate-y-2 hover:border-[var(--accent)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.6),0_0_20px_rgba(209,47,104,0.1)]"
              >
                ...
                <span className="mt-6 block font-display text-lg uppercase leading-tight tracking-wide text-[#f7f3ec] transition-colors group-hover:text-[var(--accent)]">{c.titulo}</span>
                <span className="mt-1 block text-[10px] font-bold uppercase tracking-widest text-[#7d6f5c]" style={{ fontFamily: "var(--font-display)" }}>
