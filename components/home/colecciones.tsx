  ...
  return (
    <section className="border-b border-[var(--line)] px-4 py-14 sm:px-6 md:py-20" aria-labelledby="colecciones-title">
      <div className="mx-auto max-w-[1700px]">
        <p className="text-[10px] font-black uppercase tracking-[0.35em] text-[var(--accent-ink)]" style={{ fontFamily: "var(--font-display)" }}>Momentos que marcan la ciudad</p>
        <h2 id="colecciones-title" className="mt-3 font-display text-4xl uppercase leading-[0.9] tracking-tight text-[var(--text)] sm:text-5xl md:text-6xl">
          Eventos y <span className="text-[var(--accent-ink)]">colecciones.</span>
        </h2>
          ...
          {activas.map((c) => {
            ...
            return (
              ...
              >
                ...
                <span className="mt-6 block font-display text-lg uppercase leading-tight tracking-wide text-[var(--text)] transition-colors group-hover:text-[var(--accent-ink)]">{c.titulo}</span>
