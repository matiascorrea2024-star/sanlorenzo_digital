  ...
  return (
    <main className="bg-[#0c0a0b] text-white min-h-screen">
      ...
      <div className="mx-auto max-w-2xl px-4 py-12">
        <p className="text-sm text-white/40">Última actualización: agosto 2026 · San Lorenzo, Santa Fe, Argentina</p>

        <div className="mt-10 space-y-10">
          {[
            { t: "Datos que recopilamos", body: (
              <ul className="list-disc space-y-1.5 pl-5">
                <li><strong className="text-white">Cuenta:</strong> email y nombre al registrarte como comerciante o usuario.</li>
                <li><strong className="text-white">Navegación:</strong> dirección IP, tipo de dispositivo y páginas visitadas, con fines estadísticos y de seguridad.</li>
                <li><strong className="text-white">Datos de negocios:</strong> la información que el comerciante decide publicar (nombre, dirección, fotos, ofertas, WhatsApp).</li>
              </ul>
            ) },
            ...
            <section key={s.t} className="border-t border-white/[.06] pt-6 first:border-t-0 first:pt-0">
              ...
              <div className="mt-3 text-sm leading-[1.75] text-white/70">{s.body}</div>
            </section>
          ))}
        </div>
      </div>
