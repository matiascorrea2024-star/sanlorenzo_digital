    ...
    <main className="bg-[#120d09] text-white min-h-screen">
      <div className="mx-auto max-w-3xl px-4 py-10">
        ...
        <section className="mt-8 rounded-2xl border border-orange-400/20 bg-gradient-to-b from-white/[.07] to-white/[.03] p-6 shadow-xl shadow-orange-500/10">
          <h2 className="mb-4 text-lg font-black tracking-tight bg-gradient-to-r from-orange-300 to-red-400 bg-clip-text text-transparent">📸 Fotos de tu negocio</h2>
        ...
        <section className="mt-6 rounded-2xl border border-orange-400/20 bg-gradient-to-b from-white/[.07] to-white/[.03] p-6 shadow-xl shadow-orange-500/10">
          <h2 className="mb-4 text-lg font-black tracking-tight bg-gradient-to-r from-orange-300 to-red-400 bg-clip-text text-transparent">📋 Datos del negocio</h2>
        ...
        <section className="mt-6 rounded-2xl border border-orange-400/20 bg-gradient-to-b from-white/[.07] to-white/[.03] p-6 shadow-xl shadow-orange-500/10">
          <div className="mb-4 flex items-center justify-between">
            ...
            <button onClick={() => setItems([...items, { name: "", price: "", note: "", photo: "" }])} className="rounded-lg bg-gradient-to-r from-orange-500 to-red-600 px-3 py-1.5 text-sm font-bold text-white">+ Agregar</button>
          </div>
        ...
        <section className="mt-6 rounded-2xl border border-orange-400/20 bg-gradient-to-b from-white/[.07] to-white/[.03] p-6 shadow-xl shadow-orange-500/10">
          <div className="mb-4 flex items-center justify-between">
            ...
            <button onClick={() => setPromos([...promos, { title: "", discount: "", expires: "" }])} className="rounded-lg bg-gradient-to-r from-orange-500 to-red-600 px-3 py-1.5 text-sm font-bold text-white">+ Agregar</button>
          </div>
        ...
        {stats && (
          <section className="mt-6 rounded-2xl border border-orange-400/20 bg-gradient-to-b from-white/[.07] to-white/[.03] p-6 shadow-xl shadow-orange-500/10">
            ...
            <h2 className="mb-4 text-lg font-black tracking-tight bg-gradient-to-r from-orange-300 to-red-400 bg-clip-text text-transparent">📊 Estadísticas de tu negocio (últimos 7 días)</h2>
        ...
        <div className="mt-6 flex items-center gap-4">
          <button onClick={save} disabled={saving} className="rounded-lg bg-gradient-to-r from-orange-500 to-red-600 px-6 py-3 text-sm font-black text-white hover:opacity-90 disabled:opacity-40">
