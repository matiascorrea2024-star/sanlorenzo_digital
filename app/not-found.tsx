...
export default function NotFound() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-[var(--bg)] px-4 text-center text-[var(--text)]">
      ...
      <h1 className="mt-4 text-2xl font-black" style={{ fontFamily: "var(--font-space)" }}>Esta página no existe</h1>
      ...
      <div className="mt-6 flex flex-wrap justify-center gap-3">
        ...
        <Link href="/buscar" className="rounded-xl border border-[var(--line-strong)] px-5 py-3 text-sm font-bold hover:bg-[var(--ov-05)]">🔍 Buscar negocios</Link>
        <Link href="/promociones" className="rounded-xl border border-[var(--line-strong)] px-5 py-3 text-sm font-bold hover:bg-[var(--ov-05)]">🔥 Ver ofertas</Link>
      </div>
    </main>
  );
}
