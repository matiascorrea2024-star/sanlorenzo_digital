...
export default async function Page() {
  ...
  const [{ data, count }] = await Promise.all([
    sb
      .from("businesses")
      .select("id, name, slug, category, rating, reviews, open, description, portada_url, address, whatsapp, plan, status, type, hace_envios, destacado, destacado_mes, boost_nuevo_hasta, updated_at", { count: "exact" })
