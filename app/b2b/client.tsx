  ...
  return (
    <main className="min-h-screen bg-[#0c0a0b] text-[#f7f3ec] pb-24">
      ...
      <div className="mx-auto max-w-6xl px-4 py-12">
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {SECTORES.map(s => (
            <Link key={s.id} href={`/negocios?categoria=${s.id}`}
              className="group rounded-[2rem] border border-white/5 bg-[#161314] p-6 transition-all duration-700 ease-[cubic-bezier(0.165,0.84,0.44,1)] hover:-translate-y-2 hover:border-[var(--accent)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.6),0_0_20px_rgba(209,47,104,0.1)]">
              ...
              <p className="text-sm leading-relaxed text-[#a99b86]">{s.desc}</p>
        ...
        {/* CTA comercial B2B */}
        <div className="mt-12 rounded-[2rem] border border-[var(--accent)]/25 bg-[#161314] p-8 shadow-[0_0_40px_rgba(209,47,104,0.08)] md:p-12">
          <div className="grid gap-6 md:grid-cols-2 md:items-center">
            ...
            <div className="flex flex-col gap-3 md:items-end">
              ...
              <Link href="/planes"
                className="inline-block rounded-full border border-white/10 px-8 py-4 text-xs font-black uppercase tracking-widest text-[#a99b86] transition hover:border-[var(--accent)] hover:text-white" style={{ fontFamily: "var(--font-display)" }}>
