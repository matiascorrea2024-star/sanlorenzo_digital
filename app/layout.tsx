...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="es" className={`${inter.variable} ${space.variable}`}><body>{<Header/>}{children}<Footer/></body></html>}
